                ...
                >
                  ...
                  >
                    <div id={toDomId('product-image-wrap', product.id, product.category)} className="relative overflow-hidden rounded-lg shadow-md aspect-[4/5] mb-6">
                      ...
                      <div id={toDomId('product-cta', product.id, product.category)} className="absolute bottom-4 left-4 rounded-full bg-white/90 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-slate-900 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        View collection
                      </div>
                    </div>
